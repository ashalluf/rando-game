...
| 25 | A hill chunk's contents float tens of metres in the air near --spawn=430,-1630 (boulders, now shrubs and oaks too): chunk placed off the carved height? Pre-existing on main | Hills (city_chunk hill build / MacroMap.height_at) | 4 | 4 | 1 | 16.0 | in-progress | wave 6. Found by the hill vegetation agent; see `<scratchpad>/veg/m6/slope_single.png` |
