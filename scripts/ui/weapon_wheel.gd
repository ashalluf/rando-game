...
static func _build_icons() -> void:
	...
	# Shotgun: a straight-combed stock with its semi-pistol grip, the receiver, a long barrel
	# with the magazine tube under it, the ribbed pump forend, trigger guard and front bead.
	_icons["Shotgun"] = [
		_poly([0, 13.2, 2.6, 12.8, 27, 11.9, 27, 18.2, 23.4, 20.6, 20.6, 24.6, 2.6, 28.4, 0, 28.1]),
		_poly([26.6, 11.3, 44.5, 11.3, 44.5, 18.3, 26.6, 18.3]),
		_poly([44, 11.9, 99.5, 12.5, 99.5, 14.9, 44, 15.2]),
		_poly([44, 15.4, 87.6, 15.6, 87.6, 18.2, 44, 18.2]),
		_poly([87.2, 15.1, 91.2, 15.1, 91.2, 18.6, 87.2, 18.6]),
		_poly([54.5, 14.6, 76, 14.6, 77.2, 16.6, 76.4, 20.4, 55.4, 20.4, 53.6, 17]),
		{"line": _poly([31, 18.4, 31.6, 22.2, 35.4, 23.2, 39, 21.6, 39.4, 18.4]), "width": 1.4},
		{"line": _poly([46, 11.2, 98, 11.6]), "width": 0.9},
		{"circle": Vector2(98.4, 11.2), "r": 1.0},
		{"cut": _poly([58, 15.4, 59.2, 15.4, 59.2, 19.6, 58, 19.6])},
		{"cut": _poly([61.6, 15.4, 62.8, 15.4, 62.8, 19.6, 61.6, 19.6])},
		{"cut": _poly([65.2, 15.4, 66.4, 15.4, 66.4, 19.6, 65.2, 19.6])},
		{"cut": _poly([68.8, 15.4, 70, 15.4, 70, 19.6, 68.8, 19.6])},
		{"cut": _poly([72.4, 15.4, 73.6, 15.4, 73.6, 19.6, 72.4, 19.6])},
	]
