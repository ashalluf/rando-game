...
func _build_showroom(at: Vector3, yaw: float) -> void:
	...
	for k in Aircraft.Kind.size():
		...
		add_child(jet)
	var props: Array[Mesh] = [PropFactory.model_hydrant(false), PropFactory.model_hydrant(true), PropFactory.model_trash_can(false), PropFactory.model_trash_can(true), PropFactory.model_bench(), PropFactory.model_barrier(), PropFactory.model_barrel(), PropFactory.model_tyre(), PropFactory.model_planter(), PropFactory.model_cafe_set(), PropFactory.model_lamp(), PropFactory.model_shrub(0), PropFactory.model_shrub(2), PropFactory.model_manhole(), PropFactory.model_barrier_tall(), PropFactory.model_tree(0), PropFactory.model_tree(1), PropFactory.model_tree(2), PropFactory.model_tree(3), PropFactory.model_tree(4), PropFactory.model_hill_tree(0), PropFactory.model_hill_tree(1), PropFactory.model_hill_tree(2), PropFactory.model_hill_tree(3), PropFactory.model_chaparral(), PropFactory.model_hill_oak(0)]
	for i in props.size():
