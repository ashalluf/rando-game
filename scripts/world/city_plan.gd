...
const DISTRICTS := {
	District.DOWNTOWN: {
		...
		"tree_weights": [0.14, 0.22, 0.42, 0.12, 0.10], "jacarandas": 0.10,
	...
	District.MIDTOWN: {
		...
		"tree_weights": [0.30, 0.28, 0.14, 0.16, 0.12], "jacarandas": 0.18,
	...
	District.SUBURBS: {
		...
		"tree_weights": [0.34, 0.30, 0.0, 0.20, 0.16], "jacarandas": 0.26,
	...
	District.CAMPUS: {
		...
		"tree_weights": [0.22, 0.40, 0.08, 0.16, 0.14], "jacarandas": 0.20,
		"lamp_tint": Color(0.8, 0.86, 0.8),
	...
	District.INDUSTRIAL: {
		...
		"tree_weights": [0.26, 0.26, 0.30, 0.12, 0.06], "jacarandas": 0.05,
