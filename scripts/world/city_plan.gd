...
const DISTRICTS := {
	...
	District.MIDTOWN: {
		...
		"paving": [["paving", 3.0, Color(0.98, 0.97, 0.95)], ["sidewalk", 3.0, Color(1.65, 1.65, 1.65)], ["pavers", 2.5, Color(1.20, 1.18, 1.14)]],
	...
	District.SUBURBS: {
		...
		"paving": [["sidewalk", 3.0, Color(1.65, 1.65, 1.65)], ["sidewalk", 3.0, Color(1.48, 1.48, 1.45)]],
